	...
	public static void main(String[] args) {
		...
		Por cada array(cada dia)
			...
			Verificar se tema da sess�o est� contido nos temas dos papers
				Se houver algum tema que n�o fa�a parte, retorna 0.

			Verificar se h�, no m�nimo, dois full papers
				Se n�o h�, retorna 0;

			Verificar se cada apresentador est� associado a cada paper
				Se n�o, retorna 0.
		...
		perguntar ao professor se devemos retirar papers n�o relacionados com a sess�o(ap�s decidirmos se � melhor ou n�o)
...
//		TT DD PPPPPP PPPPPPP
		...
		/* 	THE REAL DEAL NOW 
		 * 
		 * Indiv�duo : uma solu��o que representa TODOS os dias e todas as sess�es associadas
		 * 
		 * 	<DIA> <SESS�ES> <DIA> <SESS�ES> <DIA> <SESS�ES>, para 3 dias
		 * 	Ex:	
		 * 	00 01010101010 01 00000000000 10 11101010001
		 * 	
		 * 
		 *  <Sess�es>: XX YYYYYYYYY
		 * 		XX representa o hor�rio da sess�o(inicio/fim da manh�/tarde)
		 * 		YYYY.. represneta o getGenome da classe session
		 * 
		 *   verificar se o apresentador est� representador 
		 * 
		 * 	ap�s gerar aleat�riamente, � criada um objeto Conference que faz parse do cromossoma todo
		 * 
		 * 
		 * 
		 * 
